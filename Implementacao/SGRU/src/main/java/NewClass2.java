...
public class NewClass2 {
    ...
    public static void main(String[] args) {
        ...
        caixa.getVendaAlmoco()
                .add(new VendaAlmoco());
        caixa.getVendaAlmoco()
                .get(0).setFormaPagamento(txtForma);
        if (forma == 1) {
        ...
        caixa.getVendaAlmoco()
                .get(0).setValorAlmoco(valor);
        caixa.getVendaAlmoco()
                .get(0).setCaixaRU(caixa);
        System.out.println(
                "Valor para cartão: " + caixa.getVendaAlmoco().get(0).getValorAlmoco().getValorAlmoco());
        ...
        System.out.println(
                "\r------------------------------\r\r");
        System.out.println(
                "   Sistema Gerenciamento RU");
        System.out.println(
                "Rua Rua do IFRS");
        System.out.println(
                "CEP: " + 1234 + "\tFone: " + op.getTelefone());
        System.out.println(
                "CNPJ: " + 4321 + "\tIE: " + 5678);
        System.out.println(
                new Date() + "\tCodigo: " + venda.get(0).getId());
        System.out.println(
                "\tCupom Fiscal");
        System.out.println(
                "Item\t\t\tValor");
        System.out.println(
                "Almoço\t\t\t R$ " + valor.getValorAlmoco());
        System.out.println(
                "------------------------------");
        System.out.println(
                "Total\t\t\t R$ " + valor.getValorAlmoco());
